<nav x-data="{ open: false }" class="bg-white dark:bg-slate-900/10 border-b border-gray-100 dark:border-slate-600">
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button
                            ...
                            <div class="ml-1 dark:text-white">{{ Auth::user()->name }}</div>
