        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            {{-- <div class="overflow-hidden bg-white shadow-sm dark:bg-slate-700 sm:rounded-lg">
                ...
                <div
                    ...
                    exercitation in. Enim proident occaecat quis excepteur incididunt eiusmod elit adipisicing velit
                    proident veniam minim sit esse. In pariatur commodo magna laborum est. Labore proident non sint ut
            ...
            <section class="bg-white rounded-t-lg shadow-sm dark:bg-gray-900">
                <div
                    ...
                    <div class="mr-auto place-self-center lg:col-span-7">
                        <h1
                            class="max-w-2xl mb-4 text-4xl font-semibold leading-none tracking-tight md:text-5xl xl:text-6xl dark:text-white">
                        ...
                        <p
                            ...
                            components from the <a href="https://flowbite.com/docs/getting-started/introduction/"
                                class="hover:underline">Flowbite Library</a> and the <a
                ...
                <div class="max-w-screen-xl px-4 py-8 mx-auto space-y-12 lg:space-y-20 lg:py-24 lg:px-6">
                    ...
                    <div class="items-center gap-8 lg:grid lg:grid-cols-2 xl:gap-16">
                        <div class="text-gray-500 sm:text-lg dark:text-gray-400">
                            <h2 class="mb-4 text-3xl font-extrabold tracking-tight text-gray-900 dark:text-white">Work
                                with tools you already use</h2>
                            <p class="mb-8 font-light lg:text-xl">Deliver great service experiences fast - without the
                                complexity of traditional ITSM solutions. Accelerate critical development work,
                        ...
                        <img class="hidden w-full mb-4 rounded-lg lg:mb-0 lg:flex"
                            src="{{ asset('img/feature-1.png') }}" alt="dashboard feature image">
                    </div>
                    <!-- Row -->
                    <div class="items-center gap-8 lg:grid lg:grid-cols-2 xl:gap-16">
                        <img class="hidden w-full mb-4 rounded-lg lg:mb-0 lg:flex"
                            src="{{ asset('img/feature-2.png') }}" alt="feature image 2">
                        <div class="text-gray-500 sm:text-lg dark:text-gray-400">
                            <h2 class="mb-4 text-3xl font-extrabold tracking-tight text-gray-900 dark:text-white">We
                            ...
                            <ul role="list" class="pt-8 space-y-5 border-t border-gray-200 my-7 dark:border-gray-700">
                                <li class="flex space-x-3">
                                    ...
                                    <span
                                        class="text-base font-medium leading-tight text-gray-900 dark:text-white">Dynamic
